      ...
      <div className="space-y-10">
        ...
        <div className="rounded-3xl border border-dashed border-ink-200 bg-canvas-soft/40 p-10 max-w-3xl flex flex-col md:flex-row md:items-center gap-5">
          ...
          <div className="min-w-0 flex-1">
            <div className="text-[16px] font-semibold text-ink-900 tracking-[-0.005em]">
          ...
          <button
            ...
            className="group h-12 px-5 rounded-2xl bg-ink-900 hover:bg-ink-700 text-canvas-soft inline-flex items-center gap-2 text-[13.5px] font-semibold transition-all shrink-0"
          >
